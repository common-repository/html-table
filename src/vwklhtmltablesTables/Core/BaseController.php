...
abstract class vwklhtmltablesTables_Core_BaseController extends Rsc_Mvc_Controller
{
    /**
     * Returns an instance of the model.
     * @param string $model
     * @param $module
     * @return vwklhtmltablesTables_Core_BaseModel
     */
     ...
     * @returns vwklhtmltablesTables_Core_Module
     */
