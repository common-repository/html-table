...
/**
 * Class vwklhtmltablesTables_Featuredplugins_Controller
 * Featuredplugins page controller
 *
 * @package vwklhtmltablesTables\Featuredplugins
 */
class vwklhtmltablesTables_Featuredplugins_Controller extends vwklhtmltablesTables_Core_BaseController
{
    /**
    ...
    public function indexAction(Rsc_Http_Request $request)
    {
		...
		$siteUrl = 'https://vwklhtmltables.com/';
		...
		$pluginsList = array(
			...
			array('label' => $environment->translate('Digital Publication Plugin'), 'url' => $pluginsUrl. 'digital-publication-plugin/', 'img' => $uploadsUrl. '2016/07/Digital_Publication_256.png', 'desc' => $environment->translate('Digital Publication WordPress Plugin by vwklhtmltables for Magazines, Catalogs, Portfolios. Convert images, posts, PDF to the page flip book.'), 'download' => $downloadsUrl. 'digital-publications-by-vwklhtmltables.zip'),
			array('label' => $environment->translate('Contact Form Plugin'), 'url' => $pluginsUrl. 'contact-form-plugin/', 'img' => $uploadsUrl. '2016/07/Contact_Form_256.png', 'desc' => $environment->translate('One of the best plugin for creating Contact Forms on your WordPress site. Changeable fonts, backgrounds, an option for adding fields etc.'), 'download' => $downloadsUrl. 'contact-form-by-vwklhtmltables.zip'),
			array('label' => $environment->translate('Newsletter Plugin'), 'url' => $pluginsUrl. 'newsletter-plugin/', 'img' => $uploadsUrl. '2016/08/icon-256x256.png', 'desc' => $environment->translate('vwklhtmltables Newsletter plugin for automatic mailing of your letters. You will have no need to control it or send them manually. No coding, hard skills or long hours of customizing are required.'), 'download' => $downloadsUrl. 'newsletter-by-vwklhtmltables.zip'),
		);
