...
?>
<div class="vwklhtmltables-tables-wrap">
	<table 
		class="vwklhtmltables-table <?php print implode(' ', $table->settings['styling']); ?>" 
		id="vwklhtmltables-table-<?php print $table->id; ?>" 
	...
	<div 
		id="vwklhtmltables-table-<?php print $table->id; ?>-css" 
		style="display: none;">
