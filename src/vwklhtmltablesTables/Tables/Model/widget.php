...
class vwklhtmltablesTables_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        $this->tables = new vwklhtmltablesTables_Tables_Model_Tables();
        parent::__construct(
            'tables_widget',
            'Tables Widget',
    ...
    public function widget( $args, $instance ) {
        ...
        echo do_shortcode('[vwklhtmltables-tables id=' . $instance['id'] . ' position="center"]');
    ...
    public function form( $instance ) {
        ...
        if ($this->tables->getList()) {
            ...
            echo "<a href='/wp-admin/admin.php?page=vwklhtmltables-tables'>Create table</a>";
        }
