...
abstract class vwklhtmltablesTables_Ui_Asset implements vwklhtmltablesTables_Ui_AssetInterface
{
    /**
     * @var string
     */
     ...
     * @return vwklhtmltablesTables_Ui_Asset
     */
    ...
    /**
     * Adds dependency.
     * @param string|vwklhtmltablesTables_Ui_Asset $dependency
     * @return $this
     */
    public function addDependency($dependency)
    {
        if ($dependency instanceof vwklhtmltablesTables_Ui_Asset) {
