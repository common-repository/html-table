...
class vwklhtmltablesTables_Ui_Module extends vwklhtmltablesTables_Core_BaseModule
{
    /** @var  vwklhtmltablesTables_Ui_AssetInterface[] */
    private $assets;
    ...
    /**
     * Returns Assets.
     * @return vwklhtmltablesTables_Ui_AssetInterface[]
     */
    ...
    /**
     * Sets Assets.
     * @param vwklhtmltablesTables_Ui_AssetInterface[] $assets
     */
     ...
     * @param vwklhtmltablesTables_Ui_AssetInterface $asset
     * @return vwklhtmltablesTables_Ui_Module
     */
    public function add(vwklhtmltablesTables_Ui_AssetInterface $asset)
    {
        $this->assets[] = $asset;
     ...
     * @return vwklhtmltablesTables_Ui_AssetInterface|vwklhtmltablesTables_Ui_Asset
     */
    public function create($type, $handle = null)
    {
        ...
        $className = 'vwklhtmltablesTables_Ui_Style';
        if ($type === 'script') {
            $className = 'vwklhtmltablesTables_Ui_Script';
        }

        /** @var vwklhtmltablesTables_Ui_Asset $asset */
        $asset = new $className;
